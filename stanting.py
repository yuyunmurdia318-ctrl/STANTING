...
# =====================================================
# TEMA BIRU ELEGAN UNTUK WEBSITE SEKOLAH
# =====================================================
...
st.markdown("""
    ...
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #004aad, #137dfb);
        color: white;
    }
    [data-testid="stSidebar"] *, 
    ...
    /* Header biru gradasi */
    .header-school {
        background: linear-gradient(90deg, #004aad, #137dfb);
        padding: 30px;
        border-radius: 18px;
        color: white;
        text-align: center;
...
<div class="header-school">
    <h1>📘 Sistem Deteksi Dini Status Gizi Anak</h1>
    <h3>TK Hang Tuah Dumai dan Tk As Nur Dumai</h3>
    <p>Portal Pemeriksaan Kesehatan Anak MENGGUNAKAN NAIVE BAYES</p>
</div>
""", unsafe_allow_html=True)
