...
<style>
    ...
    /* Hapus background putih container */
    .block-container {
        background-color: rgba(255, 255, 255, 0.0);
        padding-top: 0rem;
    }

    /* Header gambar custom */
    .header-banner {
        width: 100%;
        height: 230px;
        border-radius: 18px;
...
# ------ HEADER WEBSITE SEKOLAH ------
st.markdown(
    f"""
    <div class="header-banner" style="background-image: url('https://img.lovepik.com/free-png/20210923/lovepik-kindergarten-png-image_401211801_wh1200.png');">
        <div class="header-title">SISTEM DETEKSI DINI STATUS GIZI ANAK</div>
        <div class="header-sub">TK Hang Tuah Dumai dan TK As Nur Dumai</div>
    </div>
    """,
    unsafe_allow_html=True
)
...
if menu == "IMT/U (WHO 2007, 5–19 tahun)":
    ...
    st.header("IMT/U (5–19 tahun)")

    # Load LMS WHO 2007
    st.sidebar.header("Data LMS WHO 2007 (IMT/U)")
    st.sidebar.write("Mengambil LMS WHO 2007 — butuh koneksi & openpyxl.")
